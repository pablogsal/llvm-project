...
// GNU-DAG: @ref_temp_tls = linkonce_odr {{.*}}thread_local global ptr null, comdat, align 8, !gnu_unique
// GNU-DAG: @_ZGV12ref_temp_tls = linkonce_odr {{.*}}thread_local global i64 0, comdat{{.*}}, align 8, !gnu_unique
// GNU-DAG: @_Z21ref_temp_var_templateIiE = linkonce_odr {{.*}}constant ptr @_ZGR21ref_temp_var_templateIiE_, comdat, align 8, !gnu_unique
// GNU-DAG: @_ZZ14ref_temp_localvE5local = linkonce_odr {{.*}}constant ptr @_ZGRZ14ref_temp_localvE5local_, comdat, align 8, !gnu_unique
// GNU-DAG: @ref_temp_dynamic_scalar = linkonce_odr {{.*}}global ptr null, comdat, align 8, !gnu_unique
// GNU-DAG: @_ZGV23ref_temp_dynamic_scalar = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8, !gnu_unique
// GNU-DAG: @ref_temp_dynamic_array = linkonce_odr {{.*}}global ptr null, comdat, align 8, !gnu_unique
...
// GNU-DAG: @ref_temp_const_list = linkonce_odr {{.*}}global %"struct.std::initializer_list" { ptr @_ZGR19ref_temp_const_list_, i64 3 }, comdat, align 8, !gnu_unique
// GNU-DAG: @ref_temp_constexpr_dtor_array = linkonce_odr {{.*}}global ptr null, comdat, align 8, !gnu_unique
...
// GNU-DAG: @ref_temp_comma_scalar = linkonce_odr {{.*}}global ptr null, comdat, align 8, !gnu_unique
// GNU-DAG: @_ZGV21ref_temp_comma_scalar = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8, !gnu_unique
// GNU-DAG: @ref_temp_comma_const_object = linkonce_odr {{.*}}global ptr null, comdat, align 8, !gnu_unique
// GNU-DAG: @_ZGV27ref_temp_comma_const_object = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8, !gnu_unique
// GNU-DAG: @ref_temp_ice_scalar = linkonce_odr {{.*}}global ptr null, comdat, align 8, !gnu_unique
// GNU-DAG: @_ZGV19ref_temp_ice_scalar = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8, !gnu_unique
// GNU-DAG: @ref_temp_ice_const_object = linkonce_odr {{.*}}global ptr null, comdat, align 8, !gnu_unique
// GNU-DAG: @_ZGV25ref_temp_ice_const_object = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8, !gnu_unique
// GNU-DAG: @_ZGR15ref_temp_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 7 }, comdat, align 4, !gnu_unique
...
// GNU-DAG: @_ZGR12ref_temp_tls_ = linkonce_odr {{.*}}thread_local constant %struct.RefTemp { i32 8 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR21ref_temp_var_templateIiE_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 9 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGRN13RefTempHolder6memberE_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 10 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGRZ14ref_temp_localvE5local_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 11 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR21ref_temp_const_scalar_ = linkonce_odr {{.*}}constant i32 42, comdat, align 4{{$}}
// GNU-DAG: @_ZGR20ref_temp_const_array_ = linkonce_odr {{.*}}constant [2 x i32] [i32 1, i32 2], comdat, align 4{{$}}
// GNU-DAG: @_ZGR26ref_temp_const_class_array_ = linkonce_odr {{.*}}constant [2 x %struct.RefTemp] [%struct.RefTemp { i32 12 }, %struct.RefTemp { i32 13 }], comdat, align 4{{$}}
// GNU-DAG: @_ZGR19ref_temp_const_list_ = linkonce_odr {{.*}}constant [3 x i32] [i32 1, i32 2, i32 3], comdat, align 4{{$}}
// GNU-DAG: @_ZGR24ref_temp_volatile_scalar_ = linkonce_odr {{.*}}constant i32 14, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR23ref_temp_volatile_array_ = linkonce_odr {{.*}}constant [2 x i32] [i32 15, i32 16], comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR30ref_temp_explicit_const_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 17 }, comdat, align 4{{$}}
// GNU-DAG: @_ZGR22ref_temp_nonconst_call_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 18 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR19ref_temp_const_call_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 19 }, comdat, align 4{{$}}
...
// GNU-DAG: @_ZGR24ref_temp_volatile_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 24 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR23ref_temp_mutable_object_ = linkonce_odr {{.*}}global %struct.RefTempMutable { i32 25 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR21ref_temp_comma_scalar_ = linkonce_odr {{.*}}constant i32 26, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR27ref_temp_comma_const_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 27 }, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR19ref_temp_ice_scalar_ = linkonce_odr {{.*}}constant i32 28, comdat, align 4, !gnu_unique
// GNU-DAG: @_ZGR25ref_temp_ice_const_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 29 }, comdat, align 4, !gnu_unique
...
// NOGNU-DAG: @ref_temp_tls = linkonce_odr {{.*}}thread_local global ptr null, comdat, align 8{{$}}
// NOGNU-DAG: @_ZGV12ref_temp_tls = linkonce_odr {{.*}}thread_local global i64 0, comdat{{.*}}, align 8{{$}}
// NOGNU-DAG: @_Z21ref_temp_var_templateIiE = linkonce_odr {{.*}}constant ptr @_ZGR21ref_temp_var_templateIiE_, comdat, align 8{{$}}
// NOGNU-DAG: @_ZZ14ref_temp_localvE5local = linkonce_odr {{.*}}constant ptr @_ZGRZ14ref_temp_localvE5local_, comdat, align 8{{$}}
// NOGNU-DAG: @ref_temp_dynamic_scalar = linkonce_odr {{.*}}global ptr null, comdat, align 8{{$}}
// NOGNU-DAG: @_ZGV23ref_temp_dynamic_scalar = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8{{$}}
// NOGNU-DAG: @ref_temp_dynamic_array = linkonce_odr {{.*}}global ptr null, comdat, align 8{{$}}
...
// NOGNU-DAG: @ref_temp_const_list = linkonce_odr {{.*}}global %"struct.std::initializer_list" { ptr @_ZGR19ref_temp_const_list_, i64 3 }, comdat, align 8{{$}}
// NOGNU-DAG: @ref_temp_constexpr_dtor_array = linkonce_odr {{.*}}global ptr null, comdat, align 8{{$}}
...
// NOGNU-DAG: @ref_temp_comma_scalar = linkonce_odr {{.*}}global ptr null, comdat, align 8{{$}}
// NOGNU-DAG: @_ZGV21ref_temp_comma_scalar = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8{{$}}
// NOGNU-DAG: @ref_temp_comma_const_object = linkonce_odr {{.*}}global ptr null, comdat, align 8{{$}}
// NOGNU-DAG: @_ZGV27ref_temp_comma_const_object = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8{{$}}
// NOGNU-DAG: @ref_temp_ice_scalar = linkonce_odr {{.*}}global ptr null, comdat, align 8{{$}}
// NOGNU-DAG: @_ZGV19ref_temp_ice_scalar = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8{{$}}
// NOGNU-DAG: @ref_temp_ice_const_object = linkonce_odr {{.*}}global ptr null, comdat, align 8{{$}}
// NOGNU-DAG: @_ZGV25ref_temp_ice_const_object = linkonce_odr {{.*}}global i64 0, comdat{{.*}}, align 8{{$}}
// NOGNU-DAG: @_ZGR15ref_temp_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 7 }, comdat, align 4{{$}}
...
// NOGNU-DAG: @_ZGR12ref_temp_tls_ = linkonce_odr {{.*}}thread_local constant %struct.RefTemp { i32 8 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR21ref_temp_var_templateIiE_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 9 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGRN13RefTempHolder6memberE_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 10 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGRZ14ref_temp_localvE5local_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 11 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR21ref_temp_const_scalar_ = linkonce_odr {{.*}}constant i32 42, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR20ref_temp_const_array_ = linkonce_odr {{.*}}constant [2 x i32] [i32 1, i32 2], comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR26ref_temp_const_class_array_ = linkonce_odr {{.*}}constant [2 x %struct.RefTemp] [%struct.RefTemp { i32 12 }, %struct.RefTemp { i32 13 }], comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR19ref_temp_const_list_ = linkonce_odr {{.*}}constant [3 x i32] [i32 1, i32 2, i32 3], comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR24ref_temp_volatile_scalar_ = linkonce_odr {{.*}}constant i32 14, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR23ref_temp_volatile_array_ = linkonce_odr {{.*}}constant [2 x i32] [i32 15, i32 16], comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR30ref_temp_explicit_const_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 17 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR22ref_temp_nonconst_call_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 18 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR19ref_temp_const_call_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 19 }, comdat, align 4{{$}}
...
// NOGNU-DAG: @_ZGR24ref_temp_volatile_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 24 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR23ref_temp_mutable_object_ = linkonce_odr {{.*}}global %struct.RefTempMutable { i32 25 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR21ref_temp_comma_scalar_ = linkonce_odr {{.*}}constant i32 26, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR27ref_temp_comma_const_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 27 }, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR19ref_temp_ice_scalar_ = linkonce_odr {{.*}}constant i32 28, comdat, align 4{{$}}
// NOGNU-DAG: @_ZGR25ref_temp_ice_const_object_ = linkonce_odr {{.*}}constant %struct.RefTemp { i32 29 }, comdat, align 4{{$}}
